...
<div class="page-header">
    ...
    <div class="page-header-actions">
        <a href="<?= APP_URL ?>/admin/dashboard" class="btn btn-secondary">← Back</a>
    </div>
</div>
...
<div style="max-width:480px">
    <div class="form-card">
        ...
        <form method="POST" action="<?= APP_URL ?>/admin/password">
            <?= Security::csrfField() ?>
            ...
            <div class="form-footer">
                <a href="<?= APP_URL ?>/admin/dashboard" class="btn btn-secondary">Cancel</a>
